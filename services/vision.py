...
Handles face detection, landmark extraction, EAR calculation, head pose estimation, and eye region extraction.
"""
...
class VisionPipeline:
    ...
    FACE_LANDMARKS_FOR_POSE = [1, 33, 263, 61, 291, 199]
    ...
    def process_frame(self, frame: np.ndarray) -> Optional[Dict]:
        """
        Process frame and extract vision features.
        
        Returns dict with face_detected, landmarks, EAR values, head_pose, and eye regions.
    ...
    def _extract_eye_region(self, frame: np.ndarray, landmarks: List[Tuple], 
        ...
        """Extract and preprocess eye region for CNN inference. Returns 32x32 grayscale."""
        try:
            ...
            print(f"Eye extraction failed: {e}")
            return None
